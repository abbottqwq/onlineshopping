...
<form:form action="manageproduct" method="post" modelAttribute="productinfo" enctype="multipart/form-data">
    ...
    <table style="text-align: left">
        <tr>
            <td>Name</td>
            <td><input id="name" type="text" name="name" value="${productinfo.name}"/> <form:errors
        ...
        <tr>
            ...
            <td><input id="number" type="number" step="0.01" min="0" name="price"
                       value="${productinfo.price}"/><form:errors
        ...
        <tr>
            <td>type</td>
            <td>
                <select name="productTypeID" value="${productinfo.productTypeID}">
        ...
        <tr>
            <td>Upload Image</td>
            <td><input type="file" accept="image/*" name="imgFile" multiple="multiple"
                       id="imgFile"><form:errors
                    path="imgFile" cssClass="valid-error"/></td>
        </tr>
        <tr>
            <td>Description</td>
            <td><textarea id="description" rows="8" name="description">${productinfo.description}</textarea><form:errors
